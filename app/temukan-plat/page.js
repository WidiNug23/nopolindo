...
<div className="max-w-5xl mx-auto px-6 pt-10 text-center">
  ...
  >
    Cari kode plat kendaraan berdasarkan huruf depan, huruf akhir, provinsi,
    atau wilayah secara cepat dan fleksibel.
  </p>
</div>
        ...
        >
          ...
          <div className="grid gap-3 md:grid-cols-2 mb-5">
            <input
              ...
              value={searchPlat}
              onChange={(e) =>
                setSearchPlat(e.target.value.toUpperCase())
              }
            ...
            <input
              ...
              value={searchAkhir}
              onChange={(e) =>
                setSearchAkhir(e.target.value.toUpperCase())
              }
              className={`px-3 py-2 rounded-lg outline-none transition
                ${
                  darkMode
